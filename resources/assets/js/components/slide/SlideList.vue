...
<script>
    ...
    export default {
        ...
        components: {
            'ListIndex': require('./SlideListIndex.vue').default,
            'SearchBox': require('./SlideListSearch.vue').default,
        ...
        methods: {
            ...
            buildSearchMessage(params) {
                ...
                if(params.titleslide != "") {
                    params_data += "titleslide = " + params.titleslide;
                }
            ...
            getListData() {
                ...
                if (this.isSearch) {
                    q = {
                        ...
                        titleslide: this.searchParams.titleslide,
                        order: this.searchParams.buildOrderStr,
                        page: self.halaman
                    }
                    listUrl = BASE_URL + '/api/slide/search';
                }else{
                    q = {page: self.halaman}
                    listUrl = BASE_URL + '/api/slide/lists';    
                }
