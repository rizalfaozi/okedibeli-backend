            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h2 class="modal-title">Detail News</h2>
                    </div>
                ...
                <div class="tab-pane active" id="domvertical">
                    <div>
                        <table class="table table-striped">
                            <tbody>
                                <tr><td align="left"><strong>ID </strong></td><td align="left">: {{ detail.id }}</td></tr>
                                <tr><td align="left"><strong>Title </strong></td><td align="left">: {{ detail.title }}</td></tr>
                                <tr><td align="left"><strong>Summary </strong></td><td align="left">: {{ detail.email }}</td></tr>
                                <tr><td align="left"><strong>Description </strong></td><td align="left">: {{ detail.description }}</td></tr>
