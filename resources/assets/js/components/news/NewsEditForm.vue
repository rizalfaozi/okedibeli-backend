    ...
    export default {
        ...
        methods: {
            ...
            editData(){
                ...
                if(this.$route.params.id){
                    console.log("masuk");
                    axios.get(BASE_URL+'/api/news/edit/'+this.userID)
                    .then((response) => {
                        if(response.data.id){
                            this.edit = true;
                            this.loading = false;
            ...
            postData() {
                ...
                if(this.edit){
                    ...
                    urlBase = axios.post(BASE_URL+'/api/news/update/'+this.userID, formData, config);
                }else{
                    urlBase = axios.post(BASE_URL+'/api/news/post', formData, config);
                }
