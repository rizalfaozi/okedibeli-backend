<template>
    <div>
        ...
        <div class="pull-left mb10 mtn10">
            ...
            <strong class="ml5">Total Member : {{ lists.total }}</strong>
        </div>
...
<script>
    ...
    export default {
        ...
        components: {
            'ListIndex': require('./MembersListIndex.vue').default,
            'SearchBox': require('./MembersListSearch.vue').default,
            'Pagination': require('vue-plain-pagination'),
            'ViewBox': require('./MembersViewInfo.vue').default,
        ...
        methods: {
            ...
            buildSearchMessage(params) {
                ...
                if(params.startdate != "") {
                    params_data += "startdate = " + params.startdate;
                }

                if(params.enddate != "") {
                    params_data += "enddate = " + params.enddate;
                }
            ...
            getListData() {
                ...
                if (this.isSearch) {
                    ...
                    listUrl = BASE_URL + '/api/members/search';
                }else{
                    q = {page: self.halaman}
                    listUrl = BASE_URL + '/api/members/lists';    
                }
