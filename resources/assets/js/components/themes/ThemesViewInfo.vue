            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h2 class="modal-title">Detail Themes</h2>
                    </div>
                    ...
                    <div>
                        <table class="table table-striped">
                            <tbody>
                                ...
                                <tr><td align="left"><strong>Title </strong></td><td align="left">: {{ detail.name }}</td></tr>
                                <tr><td align="left"><strong>Summary </strong></td><td align="left">: {{ detail.price }}</td></tr>
