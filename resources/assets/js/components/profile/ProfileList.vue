...
<script>
    ...
    export default {
        ...
        components: {
            'ListIndex': require('./ProfileListIndex.vue').default,
            'SearchBox': require('./ProfileListSearch.vue').default,
             'ViewBox': require('./ProfileViewInfo.vue').default,
        ...
        methods: {
            ...
            getListData() {
                ...
                if (this.isSearch) {
                    ...
                    listUrl = BASE_URL + '/api/profile/search';
                }else{
                    q = {page: self.halaman}
                    listUrl = BASE_URL + '/api/profile/lists';    
                }
