...
<script>
    ...
    export default {
        ...
        components: {
            'ListIndex': require('./FitureListIndex.vue').default,
            'SearchBox': require('./FitureListSearch.vue').default,
            'ViewBox': require('./FitureViewInfo.vue').default,
        ...
        methods: {
            ...
            getListData() {
                ...
                if (this.isSearch) {
                    ...
                    listUrl = BASE_URL + '/api/fiture/search';
                }else{
                    q = {page: self.halaman}
                    listUrl = BASE_URL + '/api/fiture/lists';    
                }
