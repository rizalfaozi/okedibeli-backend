...
<script>
    ...
    export default {
        ...
        components: {
            'ListIndex': require('./ContactListIndex.vue').default,
            'SearchBox': require('./ContactListSearch.vue').default,
        ...
        methods: {
            ...
            getListData() {
                ...
                if (this.isSearch) {
                    ...
                    listUrl = BASE_URL + '/api/contact/search';
                }else{
                    q = {page: self.halaman}
                    listUrl = BASE_URL + '/api/contact/lists';    
                }
