    ...
    export default {
        ...
        methods: {
            ...
            editData(){
                ...
                if(this.$route.params.id){
                    console.log("masuk");
                    axios.get(BASE_URL+'/api/messages/edit/'+this.userID)
                    .then((response) => {
                        if(response.data.id){
                            this.edit = true;
                            this.loading = false;
            ...
            postData() {
                ...
                if(this.edit){
                    ...
                    urlBase = axios.post(BASE_URL+'/api/messages/update/'+this.userID, formData, config);
                }else{
                    urlBase = axios.post(BASE_URL+'/api/messages/store', formData, config);
                }
