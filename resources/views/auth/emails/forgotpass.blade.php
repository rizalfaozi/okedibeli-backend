...
Oops! Password Anda telah di-reset ulang. Klik tombol dibawah ini untuk membuat password baru.</p>
                         </div>   
                        ...
                        <table class="table" style="padding: 0px 15px;color: #423f3f;">
                            <tr>
                                <td><a style="display: inline-block;margin-bottom: 0;font-weight: 400;text-align: center;vertical-align: middle;touch-action: manipulation;cursor: pointer;background-image: none;border: 1px solid transparent;white-space: nowrap;padding: 5px 10px;font-size: 13px;line-height: 1.54;color: #ffffff;background-color: #03a9f4;border-color: #039be5;box-shadow: 0px 1px 0px 0px rgba(0, 0, 0, 0.04);border-radius: 2px;cursor: pointer;text-decoration: none;" href="<?php echo $url;?>/forgot?akun=<?php echo $key?>" target="_blank">Konfirmasi Password</a></td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div style="font-size:16px;"><?php echo $url;?>/forgot?akun=<?php echo $key?></div>
                                </td>    
                            </tr>
                        </table>
